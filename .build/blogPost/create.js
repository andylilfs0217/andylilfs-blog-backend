...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, title, content, author, blogPost, command, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                body = JSON.parse(event.body);
                title = body.title, content = body.content, author = body.author;
                blogPost = new blogPost_1.BlogPost(title, content, author);
                command = new lib_dynamodb_1.PutCommand({
                    TableName: process.env.DYNAMODB_BLOG_POST_TABLE,
                    Item: blogPost,
                });
                return [4 /*yield*/, dynamodbClient_1.docClient.send(command)];
            case 1:
                res = _a.sent();
                return [2 /*return*/, {
                        statusCode: 201,
