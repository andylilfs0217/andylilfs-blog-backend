...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, id, title, content, author, updatedAt, getCommand, existingPost, updatedPost, updateCommand, res;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, dynamodbClient_1.docClient.send(getCommand)];
            case 1:
                existingPost = _b.sent();
                updatedPost = __assign(__assign({}, existingPost.Item), { title: title, content: content, author: author, updatedAt: updatedAt });
                ...
                return [4 /*yield*/, dynamodbClient_1.docClient.send(updateCommand)];
            case 2:
                res = _b.sent();
                return [2 /*return*/, {
                        statusCode: 200,
